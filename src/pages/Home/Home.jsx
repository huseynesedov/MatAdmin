            ...
            <Card className="search-card">
                ...
                <Form layout="vertical" className="product-search-form">
                    <Form.Item label="Kodu">
                        ...
                        <img className='position-absolute' style={{ left: "152px", top: "6px" }} src={Images.Search_blue} alt="search" />
                    </Form.Item>
                    <Form.Item label="Adı">
                        <Input className='position-relative' placeholder="123544" />
                        <img className='position-absolute' style={{ left: "152px", top: "6px" }} src={Images.Search_blue} alt="search" />
            ...
            <Tabs defaultActiveKey="1" className="product-tabs">
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                                ...
                                <Form layout="Horizontal">
                                    <Form.Item label="Üretici">
                                        <div className='d-flex justify-content-end'>
                                            ...
                                            <img src={Images.Search_blue} className='position-absolute' style={{ right: "10px", top: "6px" }} />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Üretici Kodu">
                                        <div className='d-flex justify-content-end'>
                                            <Input
                                                value={inputs.seller_code}
                                                disabled={isDisabled}
                                                onChange={handleInputChangee}
                                                style={{ width: "240px" }} placeholder="123544" />
                                        </div>
                                    </Form.Item>
                            ...
                            <Card className="info-card" title="Diğer Bilgiler">
                                ...
                                <Form layout="horizontal" className="mt-3">
                                    <Form.Item label="Mevcut">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "240px" }} placeholder="123544" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Oem Code">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "240px" }} placeholder="123544" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Mehsul Statusu">
                                        <div className='d-flex justify-content-end'>
                                            ...
                                            <div className='d-flex ms-5 me-5 align-items-center justify-content-center'>
                                                <Checkbox value="A" style={{ lineHeight: '32px' }} />
                        ...
                        <Col span={12}>
                            <Card className="info-card" title="Fiyat Bilgileri">
                                <Form layout="horizontal">
                                    <Form.Item label="Satış Fiyatı 1">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "77px" }} placeholder="250$" />
                                            <Input className='ms-3 position-relative' style={{ width: "77px" }} disabled />
                                    ...
                                    <Form.Item label="Satış Fiyatı 3">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "77px" }} placeholder="250$" />
                                            <Input className='ms-3 position-relative' style={{ width: "77px" }} disabled />
                                            <img className='position-absolute' style={{ top: "13px", right: "10px" }} src={Images.Down2_gray} alt="" />
                                    ...
                                    <Form.Item label="Satış Fiyatı 4">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "77px" }} placeholder="250$" />
                                            <Input className='ms-3 position-relative' style={{ width: "77px" }} disabled />
                                            <img className='position-absolute' style={{ top: "13px", right: "10px" }} src={Images.Down2_gray} alt="" />
                                    ...
                                    <Form.Item label="Satış Fiyatı 5">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "77px" }} placeholder="250$" />
                                            <Input className='ms-3 position-relative' style={{ width: "77px" }} disabled />
                                            <img className='position-absolute' style={{ top: "13px", right: "10px" }} src={Images.Down2_gray} alt="" />
                                    ...
                                    <Form.Item label="Satış Fiyatı 6">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "77px" }} placeholder="250$" />
                                            <Input className='ms-3 position-relative' style={{ width: "77px" }} disabled />
                                            <img className='position-absolute' style={{ top: "13px", right: "10px" }} src={Images.Down2_gray} alt="" />
                        ...
                        <Col span={24}>
                            <Card className="info-card mt-3" title="Ek bilgileri">
                                <Form layout="Horizontal">
                                    <Form.Item label="Ek Bilgileri 1">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "371px", height: "40px" }} placeholder="Məhsul Kodu: 12345" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Ek Bilgileri 2">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "371px", height: "40px" }} placeholder="İstehsalçı: XYZ Şirkəti" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Ek Bilgileri 3">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "371px", height: "40px" }} placeholder="İstehsal Yeri: Almaniya" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Ek Bilgileri 4">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "371px", height: "40px" }} placeholder="Qablaşdırma: 20 ədəd/sandroq" />
                                        </div>
                                    </Form.Item>
                                    <Form.Item label="Ek Bilgileri 5">
                                        <div className='d-flex justify-content-end'>
                                            <Input style={{ width: "371px", height: "40px" }} placeholder="Zəmanət: 2 il" />
                                        </div>
                                    </Form.Item>
                                </Form>
                            </Card>
                            ...
                            <Card className="info-card " title="Cep Iskonto">
                                <Form layout="Horizontal">
                                    ...
                                    <div className="Line_E2"></div>
                                    <div style={{ width: "600px" }} className='mt-4 d-flex flex-wrap justify-content-between'>
                                        <Radio>
                ...
                <TabPane tab="Oem No" key="6">
                    <Row gutter={16}>
                        ...
                        <Col span={12} className="text-right">
                            <Button type="default" icon={<img src={Images.Export_dark} alt="search" />} className="button-margin bg_none export_dark"></Button>
                    ...
                    <Row gutter={16} className="mt-4">
                        <Col span={24}>
                            <Card className="info-card mt-3" title="Qem No">
                                <Qem />
                                <div className='d-flex align-items-center justify-content-between' style={{ width: "967px" }}>
                ...
                <TabPane
                    ...
                    {isNewFoto ?
                        <div>
                            <Row gutter={16} className="mt-4">
                                <Col span={24}>
                                <PhotoUpload handleShow={handleShow} isSaveDisabled={isSaveDisabled} isDeleteDisabled={isDeleteDisabled} />
